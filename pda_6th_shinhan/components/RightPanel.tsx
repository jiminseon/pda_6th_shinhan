...
export default function RightPanel() {
  return (
    <div className="flex-shrink-0 flex flex-col gap-6 mt-[180px]" style={{ width: 250, height: 310 }}>
      <div className="bg-[#0e131dcc] shadow p-4 text-white h-full flex flex-col justify-between">
        <div>
        <div className="font-bold text-2xl mb-2 pt-[15px] pl-[15px]">새로운<br />웹트레이딩 시스템</div>
          <div className="text-xs mb-4 text-gray-300 pl-[15px]">(크롬, Edge, IE100이상)</div>
