    ...
    <div className="relative">
      ...
      <div className="relative w-full p-10 z-[2]">
            ...
            <ul className="stratLst flex flex-col gap-10">
              <li className="group relative h-[54px] transition-all hover:h-[240px] hover:py-[15px] hover:my-[13px] focus:h-[120px] cursor-pointer mb-2" tabIndex={0}>
                ...
                <div className="absolute px-6 py-3">
                  ...
                  <h3 className="font-semibold text-[20px] leading-[1.6] text-[#333]">퀀트이슈; (김상호의Earnings Revision) 경기민감주</h3>
              ...
              <li className="group relative h-[54px] transition-all hover:h-[240px] hover:py-[15px] hover:my-[13px] focus:h-[120px] cursor-pointer mb-2" tabIndex={0}>
                ...
                <div className="absolute px-6 py-3">
                  ...
                  <h3 className="font-semibold text-[20px] leading-[1.6] text-[#333]">[퀀트분석] 신한 Earnings Guide;</h3>
                  <p className="text-sm text-gray-600 h-0 group-hover:h-auto group-focus:h-auto overflow-hidden transition-all duration-300">
              ...
              <li className="group relative h-[54px] transition-all hover:h-[240px] hover:py-[15px] hover:my-[13px] focus:h-[120px] cursor-pointer mb-2">
                <div className="absolute left-0 top-0 w-[17px] h-full opacity-0 group-hover:opacity-100 group-focus:opacity-100 transition-opacity duration-300"
                  style={{
                    background: '#545fa6 url(https://www.shinhansec.com/siw/common/images/trading/bg_main_bracket.gif) 0 0 no-repeat',
                    width: '17px',
                ...
                <div className="px-6 py-3">
                  ...
                  <h2 className="font-semibold text-[20px] leading-[1.6] text-[#333]">신한 Econ Check-up; 경고음 낸 미국 재정에도</h2>
              ...
              <li className="group relative h-[54px] transition-all hover:h-[240px] hover:py-[15px] hover:my-[13px] focus:h-[120px] cursor-pointer mb-2">
                ...
                <div className="px-6 py-3">
                  ...
                  <h3 className="font-semibold text-[20px] leading-[1.6] text-[#333]">[글로벌 주식시장] 6월 미국 주식시장 전망; V자 반등</h3>
                  <p className="text-sm text-gray-600 h-0 group-hover:h-auto overflow-hidden transition-all duration-300">
              ...
              <li className="group relative h-[54px] transition-all hover:h-[240px] hover:py-[15px] hover:my-[13px] focus:h-[120px] cursor-pointer mb-2">
                ...
                <div className="px-6 py-3">
                  ...
                  <h3 className="font-semibold text-[20px] leading-[1.6] text-[#333]">차트 릴레이 - Top down / Bottom up</h3>
                  <p className="text-sm text-gray-600 h-0 group-hover:h-auto overflow-hidden transition-all duration-300">
              ...
              {/* <li className="group relative h-[54px] transition-all hover:h-[240px] hover:py-[15px] hover:my-[13px] focus:h-[120px] cursor-pointer mb-2">
                ...
                <div className="px-6 py-3">
                  ...
                  <h3 className="font-semibold text-[20px] leading-[1.6] text-[#333]">채권전략; 5월 금통위 Preview: 과속 방지</h3>
                  <p className="text-sm text-gray-600 h-0 group-hover:h-auto overflow-hidden transition-all duration-300">
            ...
            <ul className="stratLst flex flex-col-reverse gap-10">
              <li className="group relative h-[54px] transition-all hover:h-[240px] hover:py-[15px] hover:my-[13px] focus:h-[120px] cursor-pointer mb-2" tabIndex={0}>
                ...
                <div className="absolute px-6 py-3">
                  ...
                  <h3 className="font-semibold text-[20px] leading-[1.6] text-[#333]">Global Insight: 중국 경기 바닥 확인의 증거</h3>
                  <p className="text-sm text-gray-600 h-0 group-hover:h-auto group-focus:h-auto overflow-hidden transition-all duration-300">
              ...
              <li className="group relative h-[54px] transition-all hover:h-[240px] hover:py-[15px] hover:my-[13px] focus:h-[120px] cursor-pointer mb-2" tabIndex={0}>
                ...
                <div className="absolute px-6 py-3">
                  ...
                  <h3 className="font-semibold text-[20px] leading-[1.6] text-[#333]">웹툰엔터 (WBTN.US); 길게 보아야 예쁘다</h3>
                  <p className="text-sm text-gray-600 h-0 group-hover:h-auto group-focus:h-auto overflow-hidden transition-all duration-300">
              ...
              <li className="group relative h-[54px] transition-all hover:h-[240px] hover:py-[15px] hover:my-[13px] focus:h-[120px] cursor-pointer mb-2" tabIndex={0}>
                ...
                <div className="absolute px-6 py-3">
                  ...
                  <h3 className="font-semibold text-[20px] leading-[1.6] text-[#333]">[2H25 국내 크레딧시장 전망] 역사의 반복</h3>
                  <p className="text-sm text-gray-600 h-0 group-hover:h-auto group-focus:h-auto overflow-hidden transition-all duration-300">
              ...
              <li className="group relative h-[54px] transition-all hover:h-[240px] hover:py-[15px] hover:my-[13px] focus:h-[120px] cursor-pointer mb-2" tabIndex={0}>
                ...
                <div className="absolute px-6 py-3">
                  ...
                  <h3 className="font-semibold text-[20px] leading-[1.6] text-[#333]">세계를 여는 사람들 (3월 26일)</h3>
                  <p className="text-sm text-gray-600 h-0 group-hover:h-auto group-focus:h-auto overflow-hidden transition-all duration-300">
        ...
        <div className="relative mt-4">
          <div className="relative mb-[0px] text-right z-[1]" style={{ marginTop: '-50px' }}>
            <Image
        ...
        //   width: '300px',
        //   height: '300px',
        //   background: 'url(https://www.shinhansec.com/siw/common/images/trading/bg_main_strat02.gif) 0 0 no-repeat'
        // }}
      />
